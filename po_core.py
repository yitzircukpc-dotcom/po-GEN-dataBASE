...
def _remote_post_json(base_url, path, payload, timeout=15):
...
def bootstrap_migration_token(base_url, timeout=20):
...
def test_backend_connection(base_url, timeout=20):
...
class _RemoteConnection:
    ...
    def execute(self, sql, params=(), timeout=15):
        stripped = sql.strip()
